...
namespace IniFile
{
    ...
    public class IniFile
    {
            ...
            int minValue, int maxValue)
        {
            ...
            int value;
            if (!myint.TryParse(stringValue, out value))
            {
                double dvalue;
                if (!mydouble.TryParse(stringValue, out dvalue))
                    return defaultValue;
                value = (int)dvalue;
            }
    ...
    static class myint{
        public static bool TryParse(string s, out int d){
            int i=0;
            try 
	        {	        
		        i=Convert.ToInt32(s);
    ...
    static class mydouble{
            ...
            double minValue, double maxValue)
        {
            ...
            double value;
            if (!mydouble.TryParse(stringValue, out value))
                return defaultValue;
        ...
        public bool GetBoolean(string section, string key, bool defaultValue)
        {
            ...
            return (stringValue != "0" && !stringValue.StartsWith("f", StringComparison.CurrentCultureIgnoreCase));
        }
